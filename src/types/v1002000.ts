...
export type Type_340 = Type_340_Relay | Type_340_SiblingParachain

export interface Type_340_Relay {
    __kind: 'Relay'
}

export interface Type_340_SiblingParachain {
...
export const Type_304: sts.Type<Type_304> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_307),
        V3: sts.array(() => Type_311),
        V4: sts.array(() => Type_314),
    }
})
...
export const Type_311: sts.Type<Type_311> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_311),
        SetErrorHandler: sts.array(() => Type_311),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export type Type_311 = Type_311_AliasOrigin | Type_311_BurnAsset | Type_311_BuyExecution | Type_311_ClaimAsset | Type_311_ClearError | Type_311_ClearOrigin | Type_311_ClearTopic | Type_311_ClearTransactStatus | Type_311_DepositAsset | Type_311_DepositReserveAsset | Type_311_DescendOrigin | Type_311_ExchangeAsset | Type_311_ExpectAsset | Type_311_ExpectError | Type_311_ExpectOrigin | Type_311_ExpectPallet | Type_311_ExpectTransactStatus | Type_311_ExportMessage | Type_311_HrmpChannelAccepted | Type_311_HrmpChannelClosing | Type_311_HrmpNewChannelOpenRequest | Type_311_InitiateReserveWithdraw | Type_311_InitiateTeleport | Type_311_LockAsset | Type_311_NoteUnlockable | Type_311_QueryPallet | Type_311_QueryResponse | Type_311_ReceiveTeleportedAsset | Type_311_RefundSurplus | Type_311_ReportError | Type_311_ReportHolding | Type_311_ReportTransactStatus | Type_311_RequestUnlock | Type_311_ReserveAssetDeposited | Type_311_SetAppendix | Type_311_SetErrorHandler | Type_311_SetFeesMode | Type_311_SetTopic | Type_311_SubscribeVersion | Type_311_Transact | Type_311_TransferAsset | Type_311_TransferReserveAsset | Type_311_Trap | Type_311_UniversalOrigin | Type_311_UnlockAsset | Type_311_UnpaidExecution | Type_311_UnsubscribeVersion | Type_311_WithdrawAsset

export interface Type_311_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_311_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_311_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V3MultiAsset[]
    ticket: V3MultiLocation
}

export interface Type_311_ClearError {
    __kind: 'ClearError'
}

export interface Type_311_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_311_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_311_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_311_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V3Junctions
}
...
export interface Type_311_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_311_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_311_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_311_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_311_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_311_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_311_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_311_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_311_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_311_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V3MultiAsset[]
}

export interface Type_311_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_311_ReportError {
    __kind: 'ReportError'
    value: V3QueryResponseInfo
}

export interface Type_311_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_311_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_311_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}

export interface Type_311_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V3MultiAsset[]
}

export interface Type_311_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_311[]
}

export interface Type_311_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_311[]
}

export interface Type_311_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_311_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_311_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}
...
export interface Type_311_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_311_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_311_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_311_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}

export interface Type_311_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export const Type_307: sts.Type<Type_307> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_307),
        SetErrorHandler: sts.array(() => Type_307),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_307 = Type_307_BuyExecution | Type_307_ClaimAsset | Type_307_ClearError | Type_307_ClearOrigin | Type_307_DepositAsset | Type_307_DepositReserveAsset | Type_307_DescendOrigin | Type_307_ExchangeAsset | Type_307_HrmpChannelAccepted | Type_307_HrmpChannelClosing | Type_307_HrmpNewChannelOpenRequest | Type_307_InitiateReserveWithdraw | Type_307_InitiateTeleport | Type_307_QueryHolding | Type_307_QueryResponse | Type_307_ReceiveTeleportedAsset | Type_307_RefundSurplus | Type_307_ReportError | Type_307_ReserveAssetDeposited | Type_307_SetAppendix | Type_307_SetErrorHandler | Type_307_SubscribeVersion | Type_307_Transact | Type_307_TransferAsset | Type_307_TransferReserveAsset | Type_307_Trap | Type_307_UnsubscribeVersion | Type_307_WithdrawAsset
...
export type Type_304 = Type_304_V2 | Type_304_V3 | Type_304_V4

export interface Type_304_V2 {
    __kind: 'V2'
    value: Type_307[]
}

export interface Type_304_V3 {
    __kind: 'V3'
    value: Type_311[]
}

export interface Type_304_V4 {
    __kind: 'V4'
    value: Type_314[]
}
