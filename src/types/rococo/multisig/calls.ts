...
import * as v1012000 from '../v1012000'
...
export const asMultiThreshold1 =  {
    ...
    v1011000: new CallType(
        'Multisig.as_multi_threshold_1',
        sts.struct({
            otherSignatories: sts.array(() => v1011000.AccountId32),
            call: v1011000.Call,
        })
    ),
    /**
     ...
     * O(Z + C) where Z is the length of the call and C its execution weight.
     */
    v1012000: new CallType(
        'Multisig.as_multi_threshold_1',
        sts.struct({
            otherSignatories: sts.array(() => v1012000.AccountId32),
            call: v1012000.Call,
        })
    ),
    /**
     ...
     * O(Z + C) where Z is the length of the call and C its execution weight.
     */
    v1013000: new CallType(
        'Multisig.as_multi_threshold_1',
        sts.struct({
            otherSignatories: sts.array(() => v1013000.AccountId32),
            call: v1013000.Call,
        })
    ),
}
...
export const asMulti =  {
    ...
    v1011000: new CallType(
        ...
        sts.struct({
            threshold: sts.number(),
            otherSignatories: sts.array(() => v1011000.AccountId32),
            maybeTimepoint: sts.option(() => v1011000.Timepoint),
            call: v1011000.Call,
            maxWeight: v1011000.Weight,
        })
    ),
    /**
     * Register approval for a dispatch to be made from a deterministic composite account if
    ...
    v1012000: new CallType(
        ...
        sts.struct({
            threshold: sts.number(),
            otherSignatories: sts.array(() => v1012000.AccountId32),
            maybeTimepoint: sts.option(() => v1012000.Timepoint),
            call: v1012000.Call,
            maxWeight: v1012000.Weight,
        })
    ),
    /**
     * Register approval for a dispatch to be made from a deterministic composite account if
    ...
    v1013000: new CallType(
        ...
        sts.struct({
            threshold: sts.number(),
            otherSignatories: sts.array(() => v1013000.AccountId32),
            maybeTimepoint: sts.option(() => v1013000.Timepoint),
            call: v1013000.Call,
            maxWeight: v1013000.Weight,
        })
    ),
}
