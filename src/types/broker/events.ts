...
export const transferred =  {
    ...
    v268: new EventType(
        ...
        sts.struct({
             ...
             */
            oldOwner: v268.AccountId32,
            /**
             * The new owner of the Region.
             */
            owner: v268.AccountId32,
        })
    ),
}
...
export const partitioned =  {
    ...
    v268: new EventType(
        ...
        sts.struct({
             ...
             */
            oldRegionId: v268.RegionId,
            /**
             * The new Regions into which it became.
             */
            newRegionIds: sts.tuple(() => [v268.RegionId, v268.RegionId]),
        })
    ),
}
...
export const coreAssigned =  {
    ...
    v268: new EventType(
        ...
        sts.struct({
             ...
             */
            assignment: sts.array(() => sts.tuple(() => [v268.CoreAssignment, sts.number()])),
        })
    ),
}

export const allowedRenewalDropped =  {
    name: 'Broker.AllowedRenewalDropped',
    /**
     * Some historical Instantaneous Core Pool payment record has been dropped.
     */
    v268: new EventType(
