...
export const OnDemandRevenueRecord: sts.Type<OnDemandRevenueRecord> = sts.struct(() => {
    return  {
        until: sts.number(),
        amount: sts.bigint(),
    }
...
export interface OnDemandRevenueRecord {
    until: number
    amount: bigint
}
...
export type Type_345 = Type_345_Relay | Type_345_SiblingParachain

export interface Type_345_Relay {
    __kind: 'Relay'
}

export interface Type_345_SiblingParachain {
...
export const ProxyType: sts.Type<ProxyType> = sts.closedEnum(() => {
    return  {
        ...
        Collator: sts.unit(),
        CoretimeRenewer: sts.unit(),
        NonTransfer: sts.unit(),
        OnDemandPurchaser: sts.unit(),
    }
})

export type ProxyType = ProxyType_Any | ProxyType_Broker | ProxyType_CancelProxy | ProxyType_Collator | ProxyType_CoretimeRenewer | ProxyType_NonTransfer | ProxyType_OnDemandPurchaser

export interface ProxyType_Any {
    __kind: 'Any'
}

export interface ProxyType_Broker {
    __kind: 'Broker'
}
...
export interface ProxyType_CoretimeRenewer {
    __kind: 'CoretimeRenewer'
}
...
export interface ProxyType_OnDemandPurchaser {
    __kind: 'OnDemandPurchaser'
}
...
export const Type_307: sts.Type<Type_307> = sts.closedEnum(() => {
    return  {
        V2: sts.array(() => Type_310),
        V3: sts.array(() => Type_314),
        V4: sts.array(() => Type_317),
    }
})
...
export const Type_317: sts.Type<Type_317> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V4Asset),
        SetAppendix: sts.array(() => Type_317),
        SetErrorHandler: sts.array(() => Type_317),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export const Type_311: sts.Type<Type_311> = sts.struct(() => {
    return  {
        encoded: sts.bytes(),
    }
})
...
export type Type_317 = Type_317_AliasOrigin | Type_317_BurnAsset | Type_317_BuyExecution | Type_317_ClaimAsset | Type_317_ClearError | Type_317_ClearOrigin | Type_317_ClearTopic | Type_317_ClearTransactStatus | Type_317_DepositAsset | Type_317_DepositReserveAsset | Type_317_DescendOrigin | Type_317_ExchangeAsset | Type_317_ExpectAsset | Type_317_ExpectError | Type_317_ExpectOrigin | Type_317_ExpectPallet | Type_317_ExpectTransactStatus | Type_317_ExportMessage | Type_317_HrmpChannelAccepted | Type_317_HrmpChannelClosing | Type_317_HrmpNewChannelOpenRequest | Type_317_InitiateReserveWithdraw | Type_317_InitiateTeleport | Type_317_LockAsset | Type_317_NoteUnlockable | Type_317_QueryPallet | Type_317_QueryResponse | Type_317_ReceiveTeleportedAsset | Type_317_RefundSurplus | Type_317_ReportError | Type_317_ReportHolding | Type_317_ReportTransactStatus | Type_317_RequestUnlock | Type_317_ReserveAssetDeposited | Type_317_SetAppendix | Type_317_SetErrorHandler | Type_317_SetFeesMode | Type_317_SetTopic | Type_317_SubscribeVersion | Type_317_Transact | Type_317_TransferAsset | Type_317_TransferReserveAsset | Type_317_Trap | Type_317_UniversalOrigin | Type_317_UnlockAsset | Type_317_UnpaidExecution | Type_317_UnsubscribeVersion | Type_317_WithdrawAsset

export interface Type_317_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V4Location
}

export interface Type_317_BurnAsset {
    __kind: 'BurnAsset'
    value: V4Asset[]
}

export interface Type_317_BuyExecution {
    __kind: 'BuyExecution'
    fees: V4Asset
    weightLimit: V3WeightLimit
}

export interface Type_317_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V4Asset[]
    ticket: V4Location
}

export interface Type_317_ClearError {
    __kind: 'ClearError'
}

export interface Type_317_ClearOrigin {
    __kind: 'ClearOrigin'
}

export interface Type_317_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_317_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}

export interface Type_317_DepositAsset {
    __kind: 'DepositAsset'
    assets: V4AssetFilter
    beneficiary: V4Location
}

export interface Type_317_DepositReserveAsset {
    __kind: 'DepositReserveAsset'
    assets: V4AssetFilter
    dest: V4Location
    xcm: V4Instruction[]
...
export interface Type_317_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V4Junctions
}

export interface Type_317_ExchangeAsset {
    __kind: 'ExchangeAsset'
    give: V4AssetFilter
    want: V4Asset[]
    maximal: boolean
...
export interface Type_317_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V4Asset[]
}

export interface Type_317_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_317_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V4Location | undefined)
}

export interface Type_317_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_317_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_317_ExportMessage {
    __kind: 'ExportMessage'
    network: V4NetworkId
    destination: V4Junctions
    xcm: V4Instruction[]
...
export interface Type_317_InitiateReserveWithdraw {
    __kind: 'InitiateReserveWithdraw'
    assets: V4AssetFilter
    reserve: V4Location
    xcm: V4Instruction[]
...
export interface Type_317_InitiateTeleport {
    __kind: 'InitiateTeleport'
    assets: V4AssetFilter
    dest: V4Location
    xcm: V4Instruction[]
...
export interface Type_317_LockAsset {
    __kind: 'LockAsset'
    asset: V4Asset
    unlocker: V4Location
}

export interface Type_317_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V4Asset
    owner: V4Location
}

export interface Type_317_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V4QueryResponseInfo
}
...
export interface Type_317_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V4Asset[]
}

export interface Type_317_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_317_ReportError {
    __kind: 'ReportError'
    value: V4QueryResponseInfo
}

export interface Type_317_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V4QueryResponseInfo
    assets: V4AssetFilter
}

export interface Type_317_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V4QueryResponseInfo
}

export interface Type_317_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V4Asset
    locker: V4Location
}

export interface Type_317_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V4Asset[]
}

export interface Type_317_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_317[]
}

export interface Type_317_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_317[]
}

export interface Type_317_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_317_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}

export interface Type_317_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: Weight
}
...
export interface Type_317_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_317_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V4Junction
}

export interface Type_317_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V4Asset
    target: V4Location
}

export interface Type_317_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V4Location | undefined)
}

export interface Type_317_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}
...
export const Type_314: sts.Type<Type_314> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V3MultiAsset),
        SetAppendix: sts.array(() => Type_314),
        SetErrorHandler: sts.array(() => Type_314),
        SetFeesMode: sts.enumStruct({
            jitWithdraw: sts.boolean(),
        }),
        SetTopic: sts.bytes(),
...
export type Type_314 = Type_314_AliasOrigin | Type_314_BurnAsset | Type_314_BuyExecution | Type_314_ClaimAsset | Type_314_ClearError | Type_314_ClearOrigin | Type_314_ClearTopic | Type_314_ClearTransactStatus | Type_314_DepositAsset | Type_314_DepositReserveAsset | Type_314_DescendOrigin | Type_314_ExchangeAsset | Type_314_ExpectAsset | Type_314_ExpectError | Type_314_ExpectOrigin | Type_314_ExpectPallet | Type_314_ExpectTransactStatus | Type_314_ExportMessage | Type_314_HrmpChannelAccepted | Type_314_HrmpChannelClosing | Type_314_HrmpNewChannelOpenRequest | Type_314_InitiateReserveWithdraw | Type_314_InitiateTeleport | Type_314_LockAsset | Type_314_NoteUnlockable | Type_314_QueryPallet | Type_314_QueryResponse | Type_314_ReceiveTeleportedAsset | Type_314_RefundSurplus | Type_314_ReportError | Type_314_ReportHolding | Type_314_ReportTransactStatus | Type_314_RequestUnlock | Type_314_ReserveAssetDeposited | Type_314_SetAppendix | Type_314_SetErrorHandler | Type_314_SetFeesMode | Type_314_SetTopic | Type_314_SubscribeVersion | Type_314_Transact | Type_314_TransferAsset | Type_314_TransferReserveAsset | Type_314_Trap | Type_314_UniversalOrigin | Type_314_UnlockAsset | Type_314_UnpaidExecution | Type_314_UnsubscribeVersion | Type_314_WithdrawAsset

export interface Type_314_AliasOrigin {
    __kind: 'AliasOrigin'
    value: V3MultiLocation
}

export interface Type_314_BurnAsset {
    __kind: 'BurnAsset'
    value: V3MultiAsset[]
}
...
export interface Type_314_ClearTopic {
    __kind: 'ClearTopic'
}

export interface Type_314_ClearTransactStatus {
    __kind: 'ClearTransactStatus'
}
...
export interface Type_314_ExpectAsset {
    __kind: 'ExpectAsset'
    value: V3MultiAsset[]
}

export interface Type_314_ExpectError {
    __kind: 'ExpectError'
    value?: ([number, V3Error] | undefined)
}

export interface Type_314_ExpectOrigin {
    __kind: 'ExpectOrigin'
    value?: (V3MultiLocation | undefined)
}

export interface Type_314_ExpectPallet {
    __kind: 'ExpectPallet'
    index: number
    name: Bytes
    moduleName: Bytes
...
export interface Type_314_ExpectTransactStatus {
    __kind: 'ExpectTransactStatus'
    value: V3MaybeErrorCode
}

export interface Type_314_ExportMessage {
    __kind: 'ExportMessage'
    network: V3NetworkId
    destination: V3Junctions
    xcm: V3Instruction[]
...
export interface Type_314_LockAsset {
    __kind: 'LockAsset'
    asset: V3MultiAsset
    unlocker: V3MultiLocation
}

export interface Type_314_NoteUnlockable {
    __kind: 'NoteUnlockable'
    asset: V3MultiAsset
    owner: V3MultiLocation
}

export interface Type_314_QueryPallet {
    __kind: 'QueryPallet'
    moduleName: Bytes
    responseInfo: V3QueryResponseInfo
}
...
export interface Type_314_ReportHolding {
    __kind: 'ReportHolding'
    responseInfo: V3QueryResponseInfo
    assets: V3MultiAssetFilter
}

export interface Type_314_ReportTransactStatus {
    __kind: 'ReportTransactStatus'
    value: V3QueryResponseInfo
}

export interface Type_314_RequestUnlock {
    __kind: 'RequestUnlock'
    asset: V3MultiAsset
    locker: V3MultiLocation
}
...
export interface Type_314_SetFeesMode {
    __kind: 'SetFeesMode'
    jitWithdraw: boolean
}

export interface Type_314_SetTopic {
    __kind: 'SetTopic'
    value: Bytes
}
...
export interface Type_314_UniversalOrigin {
    __kind: 'UniversalOrigin'
    value: V3Junction
}

export interface Type_314_UnlockAsset {
    __kind: 'UnlockAsset'
    asset: V3MultiAsset
    target: V3MultiLocation
}

export interface Type_314_UnpaidExecution {
    __kind: 'UnpaidExecution'
    weightLimit: V3WeightLimit
    checkOrigin?: (V3MultiLocation | undefined)
}
...
export const Type_310: sts.Type<Type_310> = sts.closedEnum(() => {
    return  {
        ...
        ReserveAssetDeposited: sts.array(() => V2MultiAsset),
        SetAppendix: sts.array(() => Type_310),
        SetErrorHandler: sts.array(() => Type_310),
        SubscribeVersion: sts.enumStruct({
            queryId: sts.bigint(),
            maxResponseWeight: sts.bigint(),
        }),
...
export type Type_310 = Type_310_BuyExecution | Type_310_ClaimAsset | Type_310_ClearError | Type_310_ClearOrigin | Type_310_DepositAsset | Type_310_DepositReserveAsset | Type_310_DescendOrigin | Type_310_ExchangeAsset | Type_310_HrmpChannelAccepted | Type_310_HrmpChannelClosing | Type_310_HrmpNewChannelOpenRequest | Type_310_InitiateReserveWithdraw | Type_310_InitiateTeleport | Type_310_QueryHolding | Type_310_QueryResponse | Type_310_ReceiveTeleportedAsset | Type_310_RefundSurplus | Type_310_ReportError | Type_310_ReserveAssetDeposited | Type_310_SetAppendix | Type_310_SetErrorHandler | Type_310_SubscribeVersion | Type_310_Transact | Type_310_TransferAsset | Type_310_TransferReserveAsset | Type_310_Trap | Type_310_UnsubscribeVersion | Type_310_WithdrawAsset
...
export interface Type_310_ClaimAsset {
    __kind: 'ClaimAsset'
    assets: V2MultiAsset[]
    ticket: V2MultiLocation
}

export interface Type_310_ClearError {
    __kind: 'ClearError'
}

export interface Type_310_ClearOrigin {
    __kind: 'ClearOrigin'
}
...
export interface Type_310_DescendOrigin {
    __kind: 'DescendOrigin'
    value: V2Junctions
}
...
export interface Type_310_HrmpChannelAccepted {
    __kind: 'HrmpChannelAccepted'
    recipient: number
}

export interface Type_310_HrmpChannelClosing {
    __kind: 'HrmpChannelClosing'
    initiator: number
    sender: number
    recipient: number
...
export interface Type_310_HrmpNewChannelOpenRequest {
    __kind: 'HrmpNewChannelOpenRequest'
    sender: number
    maxMessageSize: number
    maxCapacity: number
...
export interface Type_310_QueryResponse {
    __kind: 'QueryResponse'
    queryId: bigint
    response: V2Response
    maxWeight: bigint
...
export interface Type_310_ReceiveTeleportedAsset {
    __kind: 'ReceiveTeleportedAsset'
    value: V2MultiAsset[]
}

export interface Type_310_RefundSurplus {
    __kind: 'RefundSurplus'
}

export interface Type_310_ReportError {
    __kind: 'ReportError'
    queryId: bigint
    dest: V2MultiLocation
    maxResponseWeight: bigint
...
export interface Type_310_ReserveAssetDeposited {
    __kind: 'ReserveAssetDeposited'
    value: V2MultiAsset[]
}

export interface Type_310_SetAppendix {
    __kind: 'SetAppendix'
    value: Type_310[]
}

export interface Type_310_SetErrorHandler {
    __kind: 'SetErrorHandler'
    value: Type_310[]
}

export interface Type_310_SubscribeVersion {
    __kind: 'SubscribeVersion'
    queryId: bigint
    maxResponseWeight: bigint
}

export interface Type_310_Transact {
    __kind: 'Transact'
    originType: V2OriginKind
    requireWeightAtMost: bigint
    call: Type_311
...
export interface Type_310_TransferAsset {
    __kind: 'TransferAsset'
    assets: V2MultiAsset[]
    beneficiary: V2MultiLocation
}

export interface Type_310_TransferReserveAsset {
    __kind: 'TransferReserveAsset'
    assets: V2MultiAsset[]
    dest: V2MultiLocation
    xcm: V2Instruction[]
...
export interface Type_310_Trap {
    __kind: 'Trap'
    value: bigint
}

export interface Type_310_UnsubscribeVersion {
    __kind: 'UnsubscribeVersion'
}

export interface Type_310_WithdrawAsset {
    __kind: 'WithdrawAsset'
    value: V2MultiAsset[]
}

export type Type_307 = Type_307_V2 | Type_307_V3 | Type_307_V4
...
export interface Type_307_V3 {
    __kind: 'V3'
    value: Type_314[]
}

export interface Type_307_V4 {
    __kind: 'V4'
    value: Type_317[]
}
...
export const BrokerCall: sts.Type<BrokerCall> = sts.closedEnum(() => {
    return  {
        ...
        notify_revenue: sts.enumStruct({
            revenue: OnDemandRevenueRecord,
        }),
 ...
 * Contains a variant per dispatchable extrinsic that this pallet has.
 */
export type BrokerCall = BrokerCall_assign | BrokerCall_claim_revenue | BrokerCall_configure | BrokerCall_drop_contribution | BrokerCall_drop_history | BrokerCall_drop_region | BrokerCall_drop_renewal | BrokerCall_interlace | BrokerCall_notify_core_count | BrokerCall_notify_revenue | BrokerCall_partition | BrokerCall_pool | BrokerCall_purchase | BrokerCall_purchase_credit | BrokerCall_renew | BrokerCall_request_core_count | BrokerCall_reserve | BrokerCall_set_lease | BrokerCall_start_sales | BrokerCall_swap_leases | BrokerCall_transfer | BrokerCall_unreserve
...
export interface BrokerCall_notify_revenue {
    __kind: 'notify_revenue'
    revenue: OnDemandRevenueRecord
}
...
export type Call = Call_Balances | Call_Broker | Call_CollatorSelection | Call_CumulusXcm | Call_MessageQueue | Call_Multisig | Call_ParachainInfo | Call_ParachainSystem | Call_PolkadotXcm | Call_Proxy | Call_Session | Call_System | Call_Timestamp | Call_Utility | Call_XcmpQueue
